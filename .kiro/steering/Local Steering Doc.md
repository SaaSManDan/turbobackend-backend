...
-------------------------------------------------------------------------------------> 
- This project is a backend that uses Nitro.js
...
- This project has a separate Worker project that handles background job processing for the MCP server. Do not create worker files (worker.js or any files in server/services/workers/) in this backend project.